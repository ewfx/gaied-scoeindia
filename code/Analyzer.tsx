  ...
  return (
    <div className="container">
      ...
      <main className="content">
        ...
        <div className="form-container">
          ...
          <div className="input-group">
            <label className="input-label" htmlFor="sender">Sender:</label>
            <input
              id="sender"
              type="text"
          ...
          {result && (
            <div className="result-box">
              <h3>
                <span role="img" aria-label="document">📝</span> Classification:
              </h3>
              <ul>
              ...
              {result.is_duplicate && (
                <div className="duplicate-warning">
                  <span role="img" aria-label="warning">🚨</span> <strong>Duplicate Email Detected!</strong>
              ...
              {/* Extracted Context */}
              <h3>
                <span role="img" aria-label="pin">📌</span> Extracted Context:
              </h3>
      ...
      <footer className="footer">
        © 2025 . All rights reserved. AI-Powered Email Classification
      </footer>
    </div>
  );
};
